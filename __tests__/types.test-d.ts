 ...
 * Optional
 */
declare const opt1: PickOptional<{ readonly a: string; readonly b: number | undefined }>;
expectType<{ readonly b?: number | undefined }>(opt1);

declare const opt2: PickOptional<{ readonly a: string; readonly b?: number | undefined }>;
expectType<{ readonly b?: number | undefined }>(opt2);

declare const opt3: PickOptional<{ readonly a: string; readonly b?: number }>;
expectType<{ readonly b?: number | undefined }>(opt3);

/**
 * Required
 */
declare const req1: PickRequired<{ readonly a: string; readonly b: number | undefined }>;
expectType<{ readonly a: string }>(req1);

declare const req2: PickRequired<{
  readonly a: string | undefined;
  readonly b?: number | undefined;
}>;
expectType<{}>(req2);

declare const req3: PickRequired<{ readonly a: string; readonly b?: number }>;
